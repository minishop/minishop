...
if ( ! isset( $_COOKIE['eucookie'] ) && slash_admin( 'cookielaw_enable' ) !== false ) {
	...
	function slashadmin_cookielaw_enqueues() {
		...
		wp_enqueue_script( 'slashadmin-cookielaw', plugins_url( 'js/cookielaw.js', dirname( __FILE__ ) ), array( 'jquery' ), SLASH_ADMIN_VERSION, false );
	}
